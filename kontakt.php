...
<!------------------------------------------------------------------
                      Tytuł strony
------------------------------------------------------------------->
                                      <title>Magdalena Olak - kontakt</title>
                                      <meta name="description" content="Magdalena Olak - kontakt" />
				...
				<div class="col-md-12 section-heading text-center">
					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2 subtext to-animate">
							<p style="margin-top: 10pt; color: rgba(255, 255, 255, 0.5); font-size:18pt;">Potrzebujesz testera do swjej firmy, zapraszam do kontaktu: TEL:&nbsp;530&nbsp;501&nbsp;056</p>
						</div>
						<div class="col-md-12">
